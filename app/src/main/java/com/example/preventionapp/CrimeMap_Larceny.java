...
public class CrimeMap_Larceny extends AppCompatActivity implements Overlay.OnClickListener, OnMapReadyCallback, NaverMap.OnCameraChangeListener, NaverMap.OnCameraIdleListener {
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        infoWindow.setAdapter(new InfoWindow.DefaultViewAdapter(this) {
            ...
            protected View getContentView(@NonNull InfoWindow infoWindow) {
                ...
                View view=View.inflate(CrimeMap_Larceny.this, R.layout.view_info_window_murder,null);
